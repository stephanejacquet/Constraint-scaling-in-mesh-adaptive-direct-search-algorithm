...
const double B250_SQRT_A = pow(10.0,-2.5);
const double B250_E1     = exp(-0.1);

const double B250_H  = 0.0625;
const double B250_H2 = 0.00390625;

const int B250_J[15][6] = {
  { 2 } ,
  { 1  , 3 } ,
  { 1  , 2  , 4 } ,
  { 1  , 2  , 3  , 5 } ,
