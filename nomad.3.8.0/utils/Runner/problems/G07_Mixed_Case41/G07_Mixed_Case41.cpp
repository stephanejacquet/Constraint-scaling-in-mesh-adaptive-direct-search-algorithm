...
/*                  constructor                 */
/*----------------------------------------------*/
G07_Mixed_Case41::G07_Mixed_Case41 ( void )
: Problem ( "G07_Mixed_Case41" , "G07_Mixed_Case41" , "xe.txt" , 10 , 9 ) {
    ...
    string temp;
    int temp2;
    ifstream fich("problems/G07_Mixed_Case41/DOE.plan");
    for (int k=0; k<7; k++)
    {
        getline(fich,temp);
    }
...
bool G07_Mixed_Case41::eval_x ( Eval_Point          & x          ,
...
/*--------------------------------------*/
void EP_G07_Mixed_Case41::construct_extended_points ( const Eval_Point & x )
{
    for (int k=0; k<6; k++)
    {
        vector<double> other_types;
        if (x[k].value()==0){
