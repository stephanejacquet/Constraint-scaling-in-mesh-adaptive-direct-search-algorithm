#include <string>
#include "ReinforcedConcreteBeamMODIC1.hpp"
...
/*------------------------------------------------*/
/*       n=3, m=3                                 */
/*       Reinforced Concrete Beam MODIC1            */
/*------------------------------------------------*/
/*----------------------------------------------*/
/*                  constructor                 */
/*----------------------------------------------*/
ReinforcedConcreteBeamMODIC1::ReinforcedConcreteBeamMODIC1 ( void )
: Problem ( "ReinforcedConcreteBeamMODIC1" , "ReinforcedConcreteBeamMODIC1" , "xe.txt" , 3 , 3 ) {
    ...
    string temp;
    int temp2;
    ifstream fich("problems/ReinforcedConcreteBeamMODIC1/DOE.plan");
    for (int k=0; k<7; k++)
    {
        getline(fich,temp);
    }
...
bool ReinforcedConcreteBeamMODIC1::eval_x ( Eval_Point          & x          ,
...
/*--------------------------------------*/
void EP_ReinforcedConcreteBeamMODIC1::construct_extended_points ( const Eval_Point & x )
{
