#include <string>
#include "ReinforcedConcreteBeamMODIDC1.hpp"
...
/*------------------------------------------------*/
/*       n=3, m=3                                 */
/*       Reinforced Concrete Beam MODIDC1            */
/*------------------------------------------------*/
/*----------------------------------------------*/
/*                  constructor                 */
/*----------------------------------------------*/
ReinforcedConcreteBeamMODIDC1::ReinforcedConcreteBeamMODIDC1 ( void )
: Problem ( "ReinforcedConcreteBeamMODIDC1" , "ReinforcedConcreteBeamMODIDC1" , "xe.txt" , 3 , 3 ) {
    ...
    string temp;
    int temp2;
    ifstream fich("problems/ReinforcedConcreteBeamMODIDC1/DOE.plan");
    for (int k=0; k<7; k++)
    {
        getline(fich,temp);
    }
...
bool ReinforcedConcreteBeamMODIDC1::eval_x ( Eval_Point          & x          ,
...
/*--------------------------------------*/
void EP_ReinforcedConcreteBeamMODIDC1::construct_extended_points ( const Eval_Point & x )
{
