#include <string>
#include "SpeedReducerMOD_Mixed_CaseIC1.hpp"
...
/*                  constructor                 */
/*----------------------------------------------*/
SpeedReducerMOD_Mixed_CaseIC1::SpeedReducerMOD_Mixed_CaseIC1 ( void )
: Problem ( "SpeedReducerMOD_Mixed_CaseIC1" , "SpeedReducerMOD_Mixed_CaseIC1" , "xe.txt" , 7 , 12 ) {
    ...
    string temp;
    int temp2;
    ifstream fich("problems/SpeedReducerMOD_Mixed_CaseIC1/DOE.plan");
    for (int k=0; k<7; k++)
    {
        getline(fich,temp);
    }
...
bool SpeedReducerMOD_Mixed_CaseIC1::eval_x ( Eval_Point          & x          ,
...
/*--------------------------------------*/
void EP_SpeedReducerMOD_Mixed_CaseIC1::construct_extended_points ( const Eval_Point & x )
{
