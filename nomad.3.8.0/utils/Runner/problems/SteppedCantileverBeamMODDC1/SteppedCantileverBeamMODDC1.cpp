#include <string>
#include "SteppedCantileverBeamMODDC1.hpp"
...
/*                  constructor                 */
/*----------------------------------------------*/
SteppedCantileverBeamMODDC1::SteppedCantileverBeamMODDC1 ( void )
: Problem ( "SteppedCantileverBeamMODDC1" , "SteppedCantileverBeamMODDC1" , "xe.txt" , 10 , 12 ) {
    ...
    string temp;
    int temp2;
    ifstream fich("problems/SteppedCantileverBeamMODDC1/DOE.plan");
    for (int k=0; k<7; k++)
    {
        getline(fich,temp);
    }
...
bool SteppedCantileverBeamMODDC1::eval_x ( Eval_Point          & x          ,
...
/*--------------------------------------*/
void EP_SteppedCantileverBeamMODDC1::construct_extended_points ( const Eval_Point & x )
{
