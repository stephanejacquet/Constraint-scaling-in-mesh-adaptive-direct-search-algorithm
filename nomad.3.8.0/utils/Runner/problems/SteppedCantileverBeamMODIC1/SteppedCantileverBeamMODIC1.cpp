#include <string>
#include "SteppedCantileverBeamMODIC1.hpp"
...
/*                  constructor                 */
/*----------------------------------------------*/
SteppedCantileverBeamMODIC1::SteppedCantileverBeamMODIC1 ( void )
: Problem ( "SteppedCantileverBeamMODIC1" , "SteppedCantileverBeamMODIC1" , "xe.txt" , 10 , 12 ) {
    ...
    string temp;
    int temp2;
    ifstream fich("problems/SteppedCantileverBeamMODIC1/DOE.plan");
    for (int k=0; k<7; k++)
    {
        getline(fich,temp);
    }
...
bool SteppedCantileverBeamMODIC1::eval_x ( Eval_Point          & x          ,
...
/*--------------------------------------*/
void EP_SteppedCantileverBeamMODIC1::construct_extended_points ( const Eval_Point & x )
{
