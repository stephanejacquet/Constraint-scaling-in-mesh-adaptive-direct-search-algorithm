...
namespace NOMAD {
    ...
    private:
        ...
        int _sort_by_diversification; 
        
    public:
        /// Access to the \c DIVERSIFICATION parameter.
        /**
         \return The \c DIVERSIFICATION parameter.
         */
        int get_diversification ( void ) const;
        void set_DIVERSIFICATION ( int sbd );
    private:    
        /*----------------------------------------------------------------------*/
    ...
    public:
        ...
        /**
         \param me \c SGTELIB_MODEL_EVAL_NB parameter -- \b IN.
         */
