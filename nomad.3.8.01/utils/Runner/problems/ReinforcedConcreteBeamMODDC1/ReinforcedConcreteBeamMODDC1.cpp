#include <string>
#include "ReinforcedConcreteBeamMODDC1.hpp"
...
/*------------------------------------------------*/
/*       n=3, m=3                                 */
/*       Reinforced Concrete Beam MODDC1            */
/*------------------------------------------------*/
/*----------------------------------------------*/
/*                  constructor                 */
/*----------------------------------------------*/
ReinforcedConcreteBeamMODDC1::ReinforcedConcreteBeamMODDC1 ( void )
: Problem ( "ReinforcedConcreteBeamMODDC1" , "ReinforcedConcreteBeamMODDC1" , "xe.txt" , 3 , 3 ) {
    ...
    string temp;
    int temp2;
    ifstream fich("problems/ReinforcedConcreteBeamMODDC1/DOE.plan");
    for (int k=0; k<7; k++)
    {
        getline(fich,temp);
    }
...
bool ReinforcedConcreteBeamMODDC1::eval_x ( Eval_Point          & x          ,
...
/*--------------------------------------*/
void EP_ReinforcedConcreteBeamMODDC1::construct_extended_points ( const Eval_Point & x )
{
