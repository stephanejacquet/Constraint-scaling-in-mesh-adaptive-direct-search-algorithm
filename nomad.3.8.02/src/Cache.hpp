...
namespace NOMAD {
    ...
    private:
        ...
        std::vector<bool> _h_has_been_recalculated;
        ...
        std::vector<NOMAD::Double> _median_outputs;
    ...
    public:
        ...
        :  _out       ( out                               ) ,
        _h_has_been_recalculated(100,false),
        _eval_type ( type                              ) ,
         
        _sizeof    ( static_cast<float>(sizeof_init()) )   {cout <<"tests \n";}
        ...
        std::vector<bool> get_h_has_been_recalculated ( void ) const { return _h_has_been_recalculated; }
        
        void set_h_has_been_recalculated ( std::vector<bool> h_has_been_recalculated) { _h_has_been_recalculated=h_has_been_recalculated; }
        ...
        vector<NOMAD::Double> get_max_of_each_output ( void );
        
        vector<NOMAD::Double> get_mean_of_each_output ( void );
        
        const vector<NOMAD::Double> & get_median_of_each_output ( bool & need_to_recalculate );
