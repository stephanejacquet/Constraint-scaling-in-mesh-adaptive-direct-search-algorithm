    ...
    class Voisin
{
  public:
    ...
    public:
        ...
        // recalculate the value of h for all the elements of the cache
        void recalculate_h(vector<NOMAD::Double> medians);
        ...
        void classification_adaptated_one_binary_constraint_ordering_basic_diversification_normalised ( NOMAD:: dd_type display_degree ,
                                                    bool         & modified_list    );
        std::set<const NOMAD::Eval_Point*> copy_cache ( NOMAD:: dd_type display_degree ,
                                                    bool         & modified_list    );
