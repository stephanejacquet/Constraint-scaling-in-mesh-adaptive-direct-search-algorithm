...
/*------------------------------------------------*/
/*       n=11, m=10                               */
/*       CarSideImpactDC case 1                   */
/*------------------------------------------------*/
/*----------------------------------------------*/
/*                  constructor                 */
/*----------------------------------------------*/
CarSideImpactDC1::CarSideImpactDC1 ( void )
: Problem ( "CarSideImpactDC1" , "CarSideImpactDC1" , "xe.txt" , 11 , 11 ) {
    ...
    string temp;
    int temp2;
    ifstream fich("problems/CarSideImpactDC1/DOE.plan");
    for (int k=0; k<7; k++)
    {
        getline(fich,temp);
    }
...
bool CarSideImpactDC1::eval_x ( Eval_Point          & x          ,
...
/*--------------------------------------*/
void EP_CarSideImpactDC1::construct_extended_points ( const Eval_Point & x )
{
    int cur;
    vector<int> other_types1;
    vector<int> other_types2;
    
    cur = static_cast<int> (x[0].value());
    switch ( cur )
    {
        case 0:
            other_types1.push_back(1);
            break;
        case 1:
            other_types1.push_back(0);
            break;
    }
